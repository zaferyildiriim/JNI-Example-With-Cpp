...
LMUSB_HANDLE __stdcall InitializeDeviceByIndex(unsigned short usVID,
                                               ...
                                               BOOL *pbDriverInstalled);//boolen 
long __stdcall TerminateDevice(long hHandle);

long __stdcall WriteUSBPacket(LMUSB_HANDLE hHandle,
                              unsigned char *pcBuffer,
                              unsigned long ulSize,
                              unsigned long *pulWritten);// pcbuffer pulwritten  
DWORD __stdcall ReadUSBPacket(LMUSB_HANDLE hHandle,
                             unsigned char *pcBuffer,
                             unsigned long ulSize,
                             unsigned long *pulRead,
                             unsigned long ulTimeoutMs,
                             HANDLE hBreak);// *pcbuffer *pulread 
